defmodule Jerboa.Format.Body.Attribute.XORMappedAddress do
  ...
  def decode(<<_::8, @ip_4, p::16, a::binary>>) do
    %Attribute{name: __MODULE__, value: %__MODULE__{family: 4, address: ip_4(a), port: port(p)}}
  end
  def decode(<<_::8, @ip_6, p::16, a::binary>>) do
    %Attribute{name: __MODULE__, value: %__MODULE__{family: 6, address: ip_6(a), port: p}}
  end
